...
export const countriesData=async(setCountries:any)=>{
    ...
    { name: "England", code: "gb-eng", flag: "https://flagcdn.com/w320/gb-eng.png" },
    { name: "Scotland", code: "gb-sct", flag: "https://flagcdn.com/w320/gb-sct.png" },
    { name: "Wales", code: "gb-wls", flag: "https://flagcdn.com/w320/gb-wls.png" },
    { name: "Northern Ireland", code: "gb-nir", flag: "https://flagcdn.com/w320/gb-nir.png" },
  ];
const response = await fetch("https://restcountries.com/v3.1/all");
 ...
 export const getCountriesList=async (setCountries:any,setManager:any)=>{
  await SpServices.SPReadItems({
            ...
            .then((items)=>{console.log("Successfull",items);
                let tempsetCountries:any[]=[];
